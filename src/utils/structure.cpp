...
structure::~structure()
{
	...
	// lisiz
	// if (extrinsic_info!=NULL) {
	// 	//delete the equilibrium constants
	// 	for (i=0;i<=numofbases;i++) {
    // 		delete[] extrinsic_info[i];
   	// 	}
   	// 	delete[] extrinsic_info;
	// }
...

{
   ...
   //initialize all positions to true:
	...
	// lisiz
//    extrinsic_info = new double *[numofbases+1];
//    for (i=0;i<=numofbases;i++) {
//     	extrinsic_info[i] = new double [i+1];
//    }
//    // initialize all positions to true:
// 	for (i=0;i<=numofbases;i++) {
// 		for (j=i;j<=numofbases;j++) {
//     		extrinsic_info[j][i] = 1.0;
// 		}
//    }
