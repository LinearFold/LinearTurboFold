...
//! Allowing user to specify the number of columns.
void MultiSequence::WriteALN(FILE *fptr, int numColumns , bool isClustal ){
    if(!sequences)
        return;
