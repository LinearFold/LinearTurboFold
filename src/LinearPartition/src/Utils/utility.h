...
void initialize()
{
    ...
    _allowed_pairs[GET_ACGU_NUM('N')][GET_ACGU_NUM('A')] = true;
    _allowed_pairs[GET_ACGU_NUM('N')][GET_ACGU_NUM('U')] = true;
    _allowed_pairs[GET_ACGU_NUM('N')][GET_ACGU_NUM('C')] = true;
    _allowed_pairs[GET_ACGU_NUM('N')][GET_ACGU_NUM('G')] = true;
    _allowed_pairs[GET_ACGU_NUM('N')][GET_ACGU_NUM('N')] = true;
